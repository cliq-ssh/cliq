package sh.cliq.backend.support.encryption
...
@TestComponent
class KeyAndHashHelper(private val secureRandom: SecureRandom = SecureRandom.getInstanceStrong()) {
    ...
    fun generateUserMasterKey(password: String, salt: ByteArray): ByteArray {
