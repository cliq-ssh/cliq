package sh.cliq.backend.config.openapi
...
class OAuthOpenApiConfig {
    @Bean
    fun oauthAuthorizationEndpoint(): OpenApiCustomizer = OpenApiCustomizer { openApi: OpenAPI ->
        val operation =
            Operation()
    ...
    @Bean
    fun oauthCallbackEndpoint(): OpenApiCustomizer = OpenApiCustomizer { openApi: OpenAPI ->
        val operation =
            Operation()
    ...
    @Bean
    fun oauthBackChannelLogoutEndpoint(): OpenApiCustomizer = OpenApiCustomizer { openApi: OpenAPI ->
        val operation =
            Operation()
